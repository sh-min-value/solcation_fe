        ...
        >
            <div className="flex items-center space-x-3">
                ...
                <div className="flex-1">
                    ...
                    <span className="text-xs text-gray-500">예정된 여정 {group.scheduled}개</span>
                    ...
                    <div className="flex items-center space-x-1 mt-1">
                        <div className="flex items-center px-1.5 py-0.5 bg-gray-100 rounded text-xs text-gray-600">
                            ...
                            <span>{group.groupLeader?.userName || '리더'} 외 {group.totalMembers-1}명</span>
                        </div>
