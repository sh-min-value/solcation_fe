  ...
  return (
    <div className="w-full relative">
      <div
        ...
        role="button"
        tabIndex={0}
        className="bg-white rounded-2xl p-4 shadow-md cursor-pointer flex items-center justify-between focus:outline-none focus:ring-2 focus:ring-blue-500 border border-gray-200"
        ...
        >
          {categories.map((category) => (
            <div
              ...
              role="option"
              tabIndex={0}
              className="px-4 py-2 cursor-pointer hover:bg-gray-50 flex items-center gap-3 transition-colors focus:outline-none focus:bg-blue-50"
