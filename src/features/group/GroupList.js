            ...
            <div className="p-6 rounded-t-3xl bg-white">
                ...
                {loading && (
                    <div className="text-center py-8">
                        <div className="text-white text-lg">그룹 목록을 불러오는 중...</div>
                    </div>
                )}
                ...
                {error && (
                    <div className="text-center py-8">
                        <div className="text-red-400 text-lg">그룹 목록을 불러올 수 없습니다.</div>
                    </div>
                )}
                ...
                {!loading && !error && (
                    <div className="space-y-4">
                        {groups.length === 0 ? (
                            <div className="text-center py-8">
                                <div className="text-white text-lg">등록된 그룹이 없습니다.</div>
                            </div>
                        ) : (
                            groups.map((group) => (
                                <GroupCard 
